...
POSTGRES_DB="users"
TABLE_USERS_SQL="CREATE TABLE IF NOT EXISTS users (id SERIAL PRIMARY KEY, username VARCHAR(255) UNIQUE NOT NULL, password CHAR(60) NOT NULL);"
...
TABLE_ADMINS_SQL="CREATE TABLE IF NOT EXISTS admins (id SERIAL PRIMARY KEY, username VARCHAR(255) UNIQUE NOT NULL, password CHAR(60) NOT NULL);"
